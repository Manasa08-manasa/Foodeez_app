        ...
        child: Container(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(14), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.4), blurRadius: 40, offset: const Offset(0, 12))]),
              child: Column(
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(padding: const EdgeInsets.only(top: 3), child: Text('$restaurantName · Outlet #402', style: AppText.body(size: 12, weight: FontWeight.w700, color: AppColors.midGrey))),
                      ],
                    ),
                  ),
                  Padding(
                  ...
                  Padding(padding: const EdgeInsets.only(top: 2), child: Align(alignment: Alignment.centerLeft, child: Text('${order.placed} · ${order.customer}', style: AppText.body(size: 11.5, color: AppColors.bodyGrey)))),
                  Container(
                    width: double.infinity,
