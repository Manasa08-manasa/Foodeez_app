      ...
      child: Container(
        ...
        child: ConstrainedBox(
          ...
          child: Container(
            ...
            padding: EdgeInsets.fromLTRB(20, 22, 20, r.safeBottom(extra: 24)),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: Text('#${order.id} · ${order.customer}', maxLines: 1, overflow: TextOverflow.ellipsis, style: AppText.body(size: 14, weight: FontWeight.w800)),
                          ),
